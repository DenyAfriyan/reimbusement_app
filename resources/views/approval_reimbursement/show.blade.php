        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <table class="table table-bordered table-striped">
                        <tbody>
                            ...
                            <tr>
                                <th>Approval</th>
                                <td>
                                    <form action="{{ url('approval-reimbursement-setujui/'.$reimbursement->reimbursement_id) }}" method="POST" onsubmit="return confirm('Apakah anda yakin?');" style="display: inline-block;">
                                    ...
                                    <form action="{{ url('approval-reimbursement-ditolak/'.$reimbursement->reimbursement_id) }}" method="POST" onsubmit="return confirm('Apakah anda yakin?');" style="display: inline-block;">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        {{-- <button type="submit" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></span></button> --}}
                    ...
                    <div class="form-group">
                        <a class="btn btn-primary btn-sm" href="{{ route('approval-reimbursement.index') }}">
                            Back
                        </a>
                    </div>
                </div>
